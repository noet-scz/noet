...
(function () {
  const DICT = {
    ru: {
      ...
      dp_folder: 'Готовая сборка', dp_folder_hint: 'Папка с собранным сайтом (в корне должен быть index.html).', dp_deploy: 'Задеплоить',
    ...
    en: {
      ...
      dp_folder: 'Built output', dp_folder_hint: 'Folder with the built site (must contain index.html at the root).', dp_deploy: 'Deploy',
